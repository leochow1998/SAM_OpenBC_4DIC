...
module domain
       ...
       integer, parameter :: nx_gl = 9720 ! Number of grid points in X
       integer, parameter :: ny_gl = 2160 ! Number of grid points in Y
       integer, parameter :: nz_gl = 28 ! Number of pressure (scalar) levels
       integer, parameter :: nsubdomains_x  = 36 ! No of subdomains in x
