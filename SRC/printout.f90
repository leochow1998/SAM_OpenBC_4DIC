	...
	if(dx.gt.0.and.dy.gt.0.and.dz.gt.0. ) then
	   ...
	   call task_abort()
        ...
        print*,'doopeny=',doopeny !leo: open_boundary_y_KW78.f90
	print*
	if(dt.gt.0) then
   ...
   print*, 'do lateral damping at the y boundary: ',dodampinglateral ! leo: damping_lateral.f90
	...
	if(donudging_tq) print*, 'Nudging of T and Q:', donudging_tq
        ...
        print*,'micro_out_freq = ',micro_out_freq ! write_fields3d_new.f90
        print*,'micro_nx_out = ',micro_nx_out ! write_fields3d_new.f90
