...
NAMELIST /PARAMETERS/ dodamping, doupperbound, docloud, doprecip, &
		...
		dosolarconstant, solar_constant, zenith_angle, rundatadir, &
                ...
                doradlat, doradlon, &
                docam4diopdata, iopfile4d, & ! leo: read4dcampinput_new.f90
                doopeny, & ! leo: open_boundary_y_KW78.f90
                micro_out_freq, micro_nx_out, & ! leo: write_fields3D_new.f90
                dodampinglateral ! leo: damping_lateral.f90
